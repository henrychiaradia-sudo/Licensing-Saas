        ...
        <table className="w-full min-w-[820px] text-sm">
          <thead>
            <tr className="border-b border-neutral-200 text-left text-[11px] uppercase tracking-wide text-neutral-400 dark:border-neutral-800">
              <th scope="col" className="px-5 py-3 font-medium">Competência</th>
              <th scope="col" className="px-5 py-3 font-medium">Licenciado</th>
              <th scope="col" className="px-5 py-3 text-right font-medium">Vendas líq.</th>
              <th scope="col" className="px-5 py-3 text-right font-medium">Declarado</th>
              <th scope="col" className="px-5 py-3 text-right font-medium">Calculado</th>
              <th scope="col" className="px-5 py-3 text-right font-medium">Variância</th>
